...
export default function ReceitaOrDespesa({ name, value, date, receita, onDeleteReceita, onDeleteDespesa, openModalReceitaOrDespesa, openModalEditReceitaOrDespesa }) {
    return (
        <Container receita={receita} onClick={openModalReceitaOrDespesa}>
            ...
            <Row2>
                ...
                <Options>
                    <ContainerIconOptions title={`Editar essa ${receita ? 'receita' : 'despesa'}`} bg="#A0C9FF" onClick={e => {
                        e.stopPropagation()
                        e.cancelBubble = true
